...
const colors = {
  ...
  glassHighlight: 'rgba(230, 179, 184, 0.15)',
  glassShadow: 'rgba(62, 14, 48, 0.5)',
  
  // Text colors
  textPrimary: '#FFFFFF',
  textSecondary: '#E6B3B8',
  ...
  inputFocus: '#E677B3',
  inputPlaceholder: 'rgba(230, 179, 184, 0.6)',
  
  // Button colors
  buttonPrimary: '#E677B3',
  buttonPrimaryHover: '#E69EA5',
  ...
  gradientAccent: 'linear-gradient(135deg, #E677B3 0%, #E69EA5 100%)',
  gradientGlass: 'linear-gradient(135deg, rgba(230, 119, 179, 0.1) 0%, rgba(230, 179, 184, 0.05) 100%)',
